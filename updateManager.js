...
var UpdateManager = class UpdateManager {
    ...
    _removeResidualPackagesBinding() {
        if (this._settings.get_boolean('residual-packages')) {
            this._launchScript(SCRIPT.REMOVERESIDUAL);
        } else {
            this._indicator._residualPackagesList = [];
            this._indicator._removeResidualPackages();
        }
    }
    ...
    _removeAutoremovablePackagesBinding() {
        if (this._settings.get_boolean('autoremovable-packages')) {
            this._launchScript(SCRIPT.REMOVEAUTO);
        } else {
            this._indicator._autoremovablePackagesList = [];
            this._indicator._removeAutoremovablePackages();
        }
    }
    ...
    _bindSettings() {
        ...
        // Synaptic features
            ...
            this._settings,
            'changed::residual-packages',
            this._removeResidualPackagesBinding.bind(this)
        ],[
            this._settings,
            ...
            this._settings,
            'changed::autoremovable-packages',
            this._removeAutoremovablePackagesBinding.bind(this)
        ],[
            // Indicator buttons
